...
# Numbers Grid base tens
# The decimal numeral system
currency = [' Reais', ' Dolares', ' Euros']
locate = ['br', 'us', 'ue']
collection = []
joins = []
...
if flag_hundred_billion and hundred_billions != 0:
    ...
    if decimal_billion_part >= 21:
        collection = str('{} {}'.format(unit[(decimal_billion_part - (9 * (int((decimal_billion_part/10)) - 2))) - (decimal_billion_part%10)], 
        unit[decimal_billion_part%10] if decimal_billion_part%10 != 0 else ''))
...
if flag_ten_billion and ten_billions != 0:
    ...
    if ten_billions >= 21:
        collection = str('{} {}'.format(unit[(ten_billions - (9 * (int((ten_billions/10)) - 2))) - (ten_billions%10)], unit[ten_billions%10] if ten_billions%10 != 0 else ''))
        collection += ' ' + unit[unit.index('Billion')]
        joins.append(collection)
...
if flag_hundred_million and hundred_millions != 0:
    ...
    if decimal_million_part >= 21:
        collection = str('{} {}'.format(unit[(decimal_million_part - (9 * (int((decimal_million_part/10)) - 2))) - (decimal_million_part%10)], 
        unit[decimal_million_part%10] if decimal_million_part%10 != 0 else ''))
...
if flag_ten_million and ten_millions != 0:
    ...
    if ten_millions >= 21:
        collection = str('{} {}'.format(unit[(ten_millions - (9 * (int((ten_millions/10)) - 2))) - (ten_millions%10)], unit[ten_millions%10] if ten_millions%10 != 0 else ''))
        collection += ' ' + unit[unit.index('Million')]
        joins.append(collection)
...
if flag_hundred_thousand and hundred_thousands != 0:
    ...
    if decimal_hundred_thousands_part >= 21:
        collection = str('{} {}'.format(unit[(decimal_hundred_thousands_part - (9 * (int((decimal_hundred_thousands_part/10)) - 2))) - (decimal_hundred_thousands_part%10)], 
        unit[decimal_hundred_thousands_part%10] if decimal_hundred_thousands_part%10 != 0 else ''))
...
if flag_ten_thousand and ten_thousands != 0:
    ...
    if ten_thousands >= 21:
        collection = str('{} {}'.format(unit[(ten_thousands - (9 * (int((ten_thousands/10)) - 2))) - (ten_thousands%10)], unit[ten_thousands%10] if ten_thousands%10 != 0 else ''))
        collection += ' ' + unit[unit.index('Thousand')]
        joins.append(collection)
